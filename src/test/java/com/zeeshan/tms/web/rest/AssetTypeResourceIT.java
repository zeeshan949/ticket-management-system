...
class AssetTypeResourceIT {
    ...
    void createAssetType() throws Exception {
        ...
        assertThat(testAssetType.getCreatedBy()).isEqualTo(DEFAULT_CREATED_BY);
        assertThat(testAssetType.getCreatedDate()).isEqualTo(DEFAULT_CREATED_DATE);
        assertThat(testAssetType.getLastModifiedBy()).isEqualTo(DEFAULT_LAST_MODIFIED_BY);
        assertThat(testAssetType.getLastModifiedDate()).isEqualTo(DEFAULT_LAST_MODIFIED_DATE);
    }
    ...
    void putExistingAssetType() throws Exception {
        ...
        assertThat(testAssetType.getCreatedBy()).isEqualTo(UPDATED_CREATED_BY);
        assertThat(testAssetType.getCreatedDate()).isEqualTo(UPDATED_CREATED_DATE);
        assertThat(testAssetType.getLastModifiedBy()).isEqualTo(UPDATED_LAST_MODIFIED_BY);
        assertThat(testAssetType.getLastModifiedDate()).isEqualTo(UPDATED_LAST_MODIFIED_DATE);
    }
    ...
    void partialUpdateAssetTypeWithPatch() throws Exception {
        ...
        partialUpdatedAssetType.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).createdDate(UPDATED_CREATED_DATE);
