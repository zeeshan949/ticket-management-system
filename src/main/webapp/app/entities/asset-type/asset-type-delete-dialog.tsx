...
export const AssetTypeDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="ticketSystemApp.assetType.delete.question">
        <Translate contentKey="ticketSystemApp.assetType.delete.question" interpolate={{ id: assetTypeEntity.id }}>
